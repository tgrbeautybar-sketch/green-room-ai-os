...
export default function RentRollPage() {
  ...
  // System sends the email reminder directly to the renter (needs a verified domain in Resend).
    ...
    <div className="space-y-6">
      ...
      <Card>
                        ...
                        <>
                          ...
                          >
                            {emailStatus[e.id] === "sending" ? "Sending…"
                              ...
                              : emailStatus[e.id] === "error" ? "Couldn't send — use email app"
                              : "✉ Email reminder"}
                          </button>
        ...
        <p className="mt-3 text-[11px] text-muted">
          ...
          <b className="text-moss-700"> Text reminder</b> opens Messages on your phone to send. <b className="text-moss-700">Email reminder</b> is sent by the system to the renter
          (needs a verified email domain in Resend — until then use "or open in my email"). Remember to <b className="text-moss-700">Save changes</b> after editing.
        </p>
      </Card>
    </div>
  );
